...
latas_utilizadas = int(litros_necessarios // litros_por_lata)
galoes_utilizados = math.ceil((litros_necessarios - latas_utilizadas * litros_por_lata) / litros_por_galao)

# Calcule o preço com a melhor combinação
